    ...
    <>
      <main className="relative flex min-h-screen flex-col justify-end overflow-hidden bg-black sm:hidden">
        ...
        <motion.div
          ...
          className="relative z-10 mt-36 flex w-full flex-col overflow-hidden rounded-t-[32px] bg-card/95 backdrop-blur-xl"
        >
          <div className="mb-6 w-full">
            <div className="mx-auto h-1.5 w-12 rounded-full bg-muted-foreground/20" />
          </div>
          <section className="flex min-w-0 items-center justify-center px-5 pb-40">
