...
type SearchInputWithAutocompleteProps<TItem> = {
  query: string;
  placeholder: string;
  searchParamName?: string;
  minChars?: number;
  ...
  onAutocompleteSelect?: (item: TItem) => void;
  inputProps?: Omit<React.ComponentProps<typeof Input>, "defaultValue" | "name" | "placeholder" | "className">;
};
...
export function SearchInputWithAutocomplete<TItem = never>({
  query,
  placeholder,
  searchParamName = "q",
  minChars = 3,
  ...
  inputProps,
}: SearchInputWithAutocompleteProps<TItem>) {
